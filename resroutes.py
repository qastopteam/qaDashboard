...
# resroutes = Blueprint('resroutes', __name__)

# @resroutes.route('/api/get_projects', methods=['GET'])
# def get_projects():
...
# @resroutes.route('/api/upload_projects', methods=['POST'])
# def upload_projects():
...
# @resroutes.route('/api/add_project', methods=['POST'])
# def add_project():
...
# @resroutes.route('/api/delete_project', methods=['POST'])
# def delete_project():
#     data = request.get_json()
...
# @resroutes.route('/api/get_project_counts', methods=['GET'])
...
# @resroutes.route('/api/get_project/<int:project_id>', methods=['GET'])
...
# @resroutes.route('/api/edit_project/<int:project_id>', methods=['POST'])
